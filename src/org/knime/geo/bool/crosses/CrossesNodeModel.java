...
/**
 * This is the model implementation of Crosses.
 * 
 *
 * @author 
 */
public class CrossesNodeModel extends NodeModel {
    ...
    private static DataTableSpec createSpec(DataTableSpec inSpec) throws InvalidSettingsException {
		...
		columns.add(new DataColumnSpecCreator("crosses", BooleanCell.TYPE).createSpec());

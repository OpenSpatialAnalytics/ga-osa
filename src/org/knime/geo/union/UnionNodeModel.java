...
/**
 * This is the model implementation of Union.
 * 
 *
 * @author Forkan
 */
public class UnionNodeModel extends NodeModel {
	...
	private static final NodeLogger logger = NodeLogger.getLogger(UnionNodeModel.class);
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
    					...
    					DataCell[] cells = new DataCell[outSpec.getNumColumns()];
    				  	try{
    	    				...
    	    				for ( int col = 0; col < numColumns; col++ ) {	
    				  		...
    				  		e.printStackTrace();
    				  		logger.error("Something wrong in Union operation at row: "+ r.getKey());
    				  	}
  	    				return cells;
    			  }
    		  };
		...
		try {
			...
			e.printStackTrace();
			logger.error("Union operation could not be completed.");
		}

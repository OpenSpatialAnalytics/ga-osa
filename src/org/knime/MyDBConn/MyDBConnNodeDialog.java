...
/**
 * <code>NodeDialog</code> for the "MyDBConn" Node.
 ...
 * 
 * TG: This MyDBConnNodeDialog  is the similar role to JDBCConnectorNodeDialog in KNIME base source code
 * can custom
 * @author TG
 */
//
...
public class MyDBConnNodeDialog extends NodeDialogPane {	
		 private final DatabaseConnectionSettings m_settings = new DatabaseConnectionSettings();
		     ...
		     */
		  //  MyDBConnNodeDialog() {
		   public  MyDBConnNodeDialog() {    //change the package visible to public visible,TG
		    ...
		    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
		    	...
		    	//System.out.println("loadSettingsFrom");
		        try {
